...
import RunningServiceList from './components/RunningServiceList.vue';
import AprovalServiceList from './components/AprovalServiceList.vue';
    ...
    <Card class="general-card" :bordered="false">
      ...
      <Tabs type="rounded" :animation="true">
        ...
        <TabPane key="1" title="所有服务">
              ...
              <Card class="service-card" style="margin-top: 3%">
                ...
                <template #actions>
                  <span class="icon-hover"
                    ><Button size="small" type="outline">查看实例</Button></span
                  >
                  <span class="icon-hover">
          ...
          <Row :gutter="24">
            <Col v-for="i in Array(7)" :key="i" :span="6">
              <Card class="aproval-service-card" style="margin-top: 3%">
                <CardMeta>
                  <template #title>
                    <TypographyText style="margin-right: 10px"> 服务名称 </TypographyText>
        ...
        <TabPane key="3" title="待审批的服务">
          <Divider style="margin-top: 0" />
          <h4>待审批的服务</h4>
          <AprovalServiceList></AprovalServiceList>
          <ListPagination></ListPagination>
        </TabPane>
      </Tabs>
    </Card>
